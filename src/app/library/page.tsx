...
import { ArrowLeft, Edit2, ChevronLeft, ChevronRight, Search } from 'lucide-react';
...
export default function LibraryPage() {
  ...
  if (isLoading) return <div className="py-12 px-4 flex items-center justify-center font-serif text-slate-500 dark:text-red-900/50 italic">Opening your library...</div>;
                ...
                <article key={post._id} className="break-inside-avoid mb-12 relative group bg-[#FDFCF8] dark:bg-zinc-950 p-8 rounded-r-2xl rounded-l-md border-y border-r border-[#E5E5E0] dark:border-red-950/30 border-l-[16px] border-l-slate-800 dark:border-l-red-950 shadow-md hover:shadow-xl dark:hover:shadow-[0_0_25px_rgba(153,27,27,0.15)] hover:-translate-y-1 transition-all duration-500 min-h-[300px] flex flex-col justify-between">
                  ...
                  <div className="relative z-10 flex-grow flex flex-col">
                    ...
                    <div className="absolute -right-2 top-0">
                      <Link href={`/edit/${post._id}`} className="p-2 inline-block rounded-full transition-colors text-slate-400 dark:text-zinc-700 hover:text-slate-800 dark:hover:text-red-500 hover:bg-slate-50 dark:hover:bg-red-900/20" title="Edit Entry">
